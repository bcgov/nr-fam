...
import {
    EmailSendingStatus,
    type FamUserRoleAssignmentResponse
} from "fam-api/model";
...
export const toAppUserGrantPermissionNotification = (
    data: FamUserRoleAssignmentResponse | null,
...
export const toDelegatedAdminGrantSuccessNotification = (
    ...
    const successRoleList: FamRoleWithClientDto[] | FamRoleWithClientDto[] =
    ...
    const conflictRoleList: FamRoleWithClientDto[] | FamRoleWithClientDto[] =
        (data.assignments_detail as FamAccessControlPrivilegeCreateResponse[])
