...
import {
    PrivilegeChangeType,
    PrivilegeDetailsPermissionType,
} from "fam-api/model";
import type { PrivilegeDetailsDto } from "fam-api/model/privilege-details-dto";

const props = defineProps<{
    permissionDetails: PrivilegeDetailsDto;
...
<template>
    ...
    <div
        v-if="
            ...
            PrivilegeDetailsPermissionType.EndUser
        "
    >
        <div
    ...
    <div
        v-if="
            props.permissionDetails.permission_type ===
            PrivilegeDetailsPermissionType.DelegatedAdmin
        "
    >
        <div class="permission-type-container">
            <p>Role:</p>
    ...
    <div
        v-if="
            props.permissionDetails.permission_type ===
            PrivilegeDetailsPermissionType.ApplicationAdmin
        "
    >
        <div class="permission-type-container">
            <p>Role:</p>
