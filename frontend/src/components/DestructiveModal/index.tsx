    ...
    >
      ...
      <div className="destructive-modal__actions">
        ...
        <Button
          kind="danger"
          size="md"
          // A removal crosses CSS, and on a scoped role it is several calls.
          // `loading` already disabled the button; this is what makes that read
          // as in progress rather than as a dead control.
          renderIcon={loading ? InlineSpinner : undefined}
          onClick={onConfirm}
          disabled={loading}
