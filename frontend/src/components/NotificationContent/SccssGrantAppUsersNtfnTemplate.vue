...
import { EmailSendingStatus, type FamUserRoleAssignmentCreateResponse } from "fam-api/model";
...
const props = defineProps<{
    assignments: FamUserRoleAssignmentCreateResponse[];
...
const visibleAssignments = computed(() => {
    const filtered = props.assignments.filter(
        ...
        (a): a is FamUserRoleAssignmentCreateResponse & { detail: NonNullable<FamUserRoleAssignmentCreateResponse['detail']> } =>
            a.detail != null
        );
