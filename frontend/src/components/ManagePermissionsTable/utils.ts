...
export const deleteAppUserRoleNotificationContext: NotificationContext<FamApplicationUserRoleAssignmentGetDto> =
    {
        action: "remove",
        entityName: "access",
 ...
 *  - `FamApplicationUserRoleAssignmentGetDto`: For App user role assignment notifications.
 ...
 * @param {FamApplicationUserRoleAssignmentGetDto | FamAccessControlPrivilegeGetResponse} data - provided
...
export const getOrganizationName = (
    data:
        | FamApplicationUserRoleAssignmentGetDto
...
export const defaultBackendPagination: PaginationType = {
    ...
    sortBy: UserRoleSortBy.CreateDate,
};
...
export const sortFieldToEnum = (
    ...
    switch (sortField) {
        case "user.user_name":
            return UserRoleSortBy.UserName;
        case "user.user_type.description":
            return UserRoleSortBy.UserTypeCode;
        case "user.first_name":
            return UserRoleSortBy.FullName;
        case "user.email":
            return UserRoleSortBy.Email;
        case "role.forest_client.forest_client_number":
            return UserRoleSortBy.ForestClientNumber;
        case "role.display_name":
            return UserRoleSortBy.RoleDisplayName;
        case "create_date":
            return UserRoleSortBy.CreateDate;
        default:
            return null;
    }
};
