...
VALUES
('TEST-3-LOAD-CHILD-1','B','test-bceidbusiness_bda2a1e212244dc2b9f9522057mangledc58bbb@bceidbusiness', '000000000000000000000000000000AA', CURRENT_USER),
('LOAD-3-TEST', 'B', 'test-bceidbusiness_532905de0aa24923ae535428mangledf171bf13@bceidbusiness', '000000000000000000000000000000AA', CURRENT_USER),
('LOAD-4-TEST', 'B', 'test-bceidbusiness_b5251dbe95724894aa698043mangled099a4de2@bceidbusiness ', '000000000000000000000000000000BB', CURRENT_USER);

-- add user_guid for TEST-3-LOAD-CHILD-1, as we use it as requester for tests
UPDATE app_fam.fam_user
SET user_guid = '000000000000000000000000000000C1'
...
UPDATE app_fam.fam_user
SET user_guid = '000000000000000000000000000000C2'
WHERE user_name = 'LOAD-3-TEST';

-- add LOCALTEST as delegated admin to manage FOM DEV role FOM_REVIEWER
...
VALUES
(
    (select user_id from app_fam.fam_user where user_name='LOCALTEST' and user_type_code='I'),
...
-- add LOCALTEST as delegated admin to manage FOM DEV role FOM_SUBMITTER with forest client number 00001018
