 ...
 *
 * <p>The rule is unchanged and deliberately conservative: <strong>both</strong>
 * the deployment and the target application must be production before a PROD
 * instance is used. FAM's PROD deployment serves DEV, TEST and PROD applications,
 * and a DEV application must never reach production data.
 *
